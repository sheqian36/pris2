...
from pris2.datasets import TextDataset
from pris2.engine_for_colorization import train_one_epoch, evaluate
...
def main(args, ds_init):
    ...
    caption_dir = 'resources/'

    dataset_train = TextDataset(img_dir, caption_dir, split='train')
    if args.disable_eval:
        dataset_val = None
    else:
        dataset_val = TextDataset(img_dir, caption_dir, split='val')

    if args.test: # 
        args.eval = True
        args.output_dir = 'test'
        dataset_val = TextDataset(img_dir, caption_dir, split='test')
